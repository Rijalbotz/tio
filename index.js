...
if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	...
	let butown = [{urlButton: {displayText: 'Creator 👦️',url: 'https://wa.me/6282221792667?text=Assalamualaikum'}}, {urlButton: {displayText: 'Follow 📱️',url: 'https://github.com/botcahx'}}, {urlButton: {displayText: 'Rest Api Me ✨️',url: 'https:www.fxacb-api.my.id'}}]
	let butcrea = [{urlButton: {displayText: 'Owner 👦️',url: `https://wa.me/${global.owner}?text=p`}}]
	...
	let txtcrea = `Halo Creator 👋, Izin Pakai Scriptnya\n\nMakasih Dah Buatin Script Ini 🙏`
	lolcatjs.fromString('Sukses Mengirim Pesan Ke Owner Dan Creator ☑️')
	tio.sendMessage(global.owner+'@s.whatsapp.net', { image: imgown, caption: txtown, footer: global.ownerName })
    tio.sendMessage('6282221792667@s.whatsapp.net', { image: imgcrea, caption: txtcrea, footer: global.ownerName })
